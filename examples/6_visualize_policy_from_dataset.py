...
if __name__ == "__main__":
    ...
    def select_random_state() -> None:
        ...
        try:
            ...
            print(f"✓ Prediction successful. Horizon length: {horizon_length(state['horizon'])}")
        except Exception as e:
            print(f"❌ Failed prediction inference: {e}")

    server.gui.add_button("🎲 Pull Random Observation").on_click(lambda _: select_random_state())
