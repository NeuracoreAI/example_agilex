...
def toggle_slow_scaling(data_manager, visualizer):
    ...
    if enabled:
        print(f"🐢 Slow scaling enabled (trans={visualizer.get_slow_translation_scale():.3f}, rot={visualizer.get_slow_rotation_scale():.3f})")
    else:
        print(f"🐇 Slow scaling disabled (trans={visualizer.get_translation_scale():.3f}, rot={visualizer.get_rotation_scale():.3f})")
