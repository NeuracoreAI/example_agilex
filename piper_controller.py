...
class PiperController:
    ...
    def cleanup(self):
        ...
        if hasattr(self, 'piper') and self.piper is not None and self.piper.get_connect_status():
    ...
    def _set_robot_status_enabled(self, enabled):
    ...
    def _initialize_robot(self):
        ...
        self.piper = C_PiperInterface_V2(self.can_interface, start_sdk_joint_limit=True, start_sdk_gripper_limit=True)
    ...
    def update_target_pose(self, linear_delta, angular_delta):
        ...
        with self.position_lock:
            ...
            if self.debug_mode:
                print(f'Pose updated: pos=[{new_pose[0]:.1f}, {new_pose[1]:.1f}, {new_pose[2]:.1f}], '
                      f'rot=[{new_pose[3]:.1f}, {new_pose[4]:.1f}, {new_pose[5]:.1f}]')


    def get_gripper_open_value(self):
    ...
    def set_gripper_open_value(self, gripper_open_value):
        ...
        with self.position_lock:            
            ...
            new_gripper_open_value = max(self.GRIPPER_LIMITS[0], min(self.GRIPPER_LIMITS[1], gripper_open_value))
    ...
    def update_gripper_open_value(self, gripper_open_value_delta):
        """Update target gripper position.
        ...
        with self.position_lock:
            ...
            # clamp gripper open value to limits
            self._gripper_open_value = max(self.GRIPPER_LIMITS[0], min(self.GRIPPER_LIMITS[1], new_gripper_open_value))
    ...
    def set_target_joint_angles(self, joint_angles):
    ...
    def update_target_joint_angles(self, joint_deltas):
        ...
        while self.running.is_set():
            try:
                ...
                if self.is_robot_enabled():
                    ...
                    if self.debug_mode:
                        print(f'Control loop: Robot not enabled, skipping command')
    ...
    def _send_end_effector_command(self, command):
    ...
    def _send_joint_command(self, joint_angles):
    ...
    def _send_gripper_command(self, gripper_open_value):
    ...
    def graceful_stop(self):
        ...
        try:
            ...
            self.piper.GripperCtrl(0, 0, 0x00, 0)
            print("Gracefully falling forward for 5 seconds. Please hold the robot if it doesn't reach home after this time!")
            time.sleep(5)
    ...
    def get_current_gripper_open_value(self):
